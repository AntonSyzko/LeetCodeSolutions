...
Input: words = ["z","x","z"]
Output: ""
Explanation: The order is invalid, so return ""..solutions.blind75;
         */
...
public  class AleinDictionary {
    ...
    private static String alienOrder2(String[] words) {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            if (i > 0) {
                connectGraph2(graph, words[i - 1], currentWord);
            }
        }
    ...
    private static void connectGraph2(Map<Character, Set<Character>> graph, String prev, String curr) {
    ...
    private static boolean topologicalSort(char vertexId, Map<Character, Set<Character>> graph,
                                           StringBuffer sb, Map<Character, Integer> visited) {
    ...
    public String alienOrder22(String[] words) {
